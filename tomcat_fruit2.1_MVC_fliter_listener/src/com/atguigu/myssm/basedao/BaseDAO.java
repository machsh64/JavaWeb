...
public abstract class BaseDAO<T> {
    ...
    public BaseDAO(){
        ...
        try {
            ...
            e.printStackTrace();
            throw new DAOException("BaseDAO 构造方法出错了 原因可能是没有指定<>中的类型");
        }
    }
    ...
    protected void close(ResultSet rs , PreparedStatement psmt , Connection conn){
        try {
            ...
            e.printStackTrace();
            throw new DAOException("BaseDAO close出错了");
        }
    }
    ...
    protected Object getValue(String sql,Object... params){
        ...
        try {
            return runner.query(getConn(),sql,scalarHandler,params);
        } catch (SQLException throwables) {
            throwables.printStackTrace();
            throw new DAOException("BaseDAO getValue出错了");
        }
    }
    ...
    protected int executeUpdate(String sql , Object... params){
        ...
        insertFlag = sql.trim().toUpperCase().startsWith("INSERT")||sql.trim().toUpperCase().startsWith("DELETE")||sql.trim().toUpperCase().startsWith("UPDATE");
        try {
            conn = getConn();
            if(insertFlag){
